...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Real-time chat application with user authentication, message history, file sharing, and emoji support.",
    technologies: ["React", "Firebase", "Socket.io", "Tailwind CSS", "React Router"],
  ...
  },
  {
    id: "6",
    title: "Recipe Finder",
    description: "A recipe discovery app that helps users find recipes based on available ingredients, dietary preferences, and cooking time.",
